...
function renderDowntimeDashboard(){
  ...
  <div class="grid dashboard-kpis downtime-kpis dashboard-module-animate">
    <div class="card kpi-card downtime-kpi-total"><div class="kpi-top"><div class="kpi-label-pill">Total Downtime</div>${kpiGear('downtime_total')}</div><div class="kpi-body"><div><div class="metric kpi-value-downtime-total" ${kpiStatusStyle('downtime_total',a.total)}>${dashNum(a.total)}</div>${downtimeDeltaMarkup('downtime_total',a.total,prev.total,'Previous Period')}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('downtime_total',a.total)}>◷</span></div></div>
    <div class="card kpi-card downtime-kpi-unplanned"><div class="kpi-top"><div class="kpi-label-pill">Unplanned Downtime</div>${kpiGear('downtime_unplanned')}</div><div class="kpi-body"><div><div class="metric kpi-value-downtime-unplanned" ${kpiStatusStyle('downtime_unplanned',a.unplanned)}>${dashNum(a.unplanned)}</div>${downtimeDeltaMarkup('downtime_unplanned',a.unplanned,prev.unplanned,'Previous Period')}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('downtime_unplanned',a.unplanned)}>!</span></div></div>
    <div class="card kpi-card downtime-kpi-planned"><div class="kpi-top"><div class="kpi-label-pill">Planned Downtime</div>${kpiGear('downtime_planned')}</div><div class="kpi-body"><div><div class="metric kpi-value-downtime-planned" ${kpiStatusStyle('downtime_planned',a.planned)}>${dashNum(a.planned)}</div>${downtimeDeltaMarkup('downtime_planned',a.planned,prev.planned,'Previous Period')}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('downtime_planned',a.planned)}>◫</span></div></div>
...
function renderQualityDashboard(){
  ...
  <div class="grid dashboard-kpis quality-kpis dashboard-module-animate">
    ...
    <div class="card kpi-card quality-kpi-ppm"><div class="kpi-top"><div class="kpi-label-pill">PPMs</div>${kpiGear('quality_ppm')}</div><div class="kpi-body"><div><div class="metric kpi-value-quality-ppm" ${kpiStatusStyle('quality_ppm',a.ppm)}>${a.ppm==null?'N/A':Math.round(a.ppm).toLocaleString()}</div>${qualityDeltaMarkup('quality_ppm',a.ppm,prev.ppm,false,'Previous Period')}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('quality_ppm',a.ppm)}>⦿</span></div></div>
    <div class="card kpi-card quality-kpi-scrap-qty"><div class="kpi-top"><div class="kpi-label-pill">Scrap Quantity</div>${kpiGear('quality_scrap_qty')}</div><div class="kpi-body"><div><div class="metric kpi-value-quality-scrap-qty" ${kpiStatusStyle('quality_scrap_qty',a.scrap)}>${dashNum(a.scrap)}</div>${qualityDeltaMarkup('quality_scrap_qty',a.scrap,prev.scrap,false,'Previous Period')}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('quality_scrap_qty',a.scrap)}>◈</span></div></div>
    <div class="card kpi-card quality-kpi-cost"><div class="kpi-top"><div class="kpi-label-pill">Scrap Cost</div>${kpiGear('quality_scrap_cost')}</div><div class="kpi-body"><div><div class="metric kpi-value-quality-cost" ${kpiStatusStyle('quality_scrap_cost',a.scrapCost)}>${dashMoney(a.scrapCost)}</div>${qualityDeltaMarkup('quality_scrap_cost',a.scrapCost,prev.scrapCost,false,'Previous Period')}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('quality_scrap_cost',a.scrapCost)}>$</span></div></div>
