...
function renderDashboardGeneral(){const box=document.getElementById('dashboardGeneral');if(!box)return;const cmp=dashboardComparison(),a=cmp.current,prev=cmp.previous,p=cmp.period;if(!a.d.prod.length){box.innerHTML='<div class="panel dashboard-empty"><div class="eyebrow">GENERAL</div><h2>No Data</h2><p>No production captures match the selected Dashboard filters.</p></div>';dashboardStatus('No Data in the selected filter scope.');return;}
 ...
 <div class="card kpi-card kpi-oee"><div class="kpi-top"><div class="kpi-label-pill">OEE</div>${kpiGear('oee')}</div><div class="kpi-body"><div><div class="metric kpi-value-oee">${dashPct(a.oee)}</div>${kpiDeltaMarkup('oee',a.oee,prev.oee,true,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true">◔</span></div></div>
 <div class="card kpi-card kpi-production"><div class="kpi-top"><div class="kpi-label-pill">Production</div>${kpiGear('production')}</div><div class="kpi-body"><div><div class="metric kpi-value-production">${dashNum(a.production)}</div>${kpiDeltaMarkup('production',a.production,prev.production,true,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true">▤</span></div></div>
 <div class="card kpi-card kpi-scrap"><div class="kpi-top"><div class="kpi-label-pill">Scrap</div>${kpiGear('scrap')}</div><div class="kpi-body"><div><div class="metric kpi-value-scrap">${dashPct(a.scrapPct)}</div>${kpiDeltaMarkup('scrap',a.scrapPct,prev.scrapPct,false,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true">⚠</span></div></div>
 <div class="card kpi-card kpi-ppm"><div class="kpi-top"><div class="kpi-label-pill">PPMs</div>${kpiGear('ppm')}</div><div class="kpi-body"><div><div class="metric kpi-value-ppm">${a.ppm==null?'N/A':Math.round(a.ppm).toLocaleString()}</div>${kpiDeltaMarkup('ppm',a.ppm,prev.ppm,false,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true">⦿</span></div></div>
 <div class="card kpi-card kpi-yield"><div class="kpi-top"><div class="kpi-label-pill">Yield</div>${kpiGear('yield')}</div><div class="kpi-body"><div><div class="metric kpi-value-yield">${dashPct(a.yieldRatio)}</div>${kpiDeltaMarkup('yield',a.yieldRatio,prev.yieldRatio,true,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true">✓</span></div></div>
 <div class="card kpi-card kpi-copq"><div class="kpi-top"><div class="kpi-label-pill">COPQ</div>${kpiGear('copq')}</div><div class="kpi-body"><div><div class="metric kpi-value-copq">${dashPct(a.copqPct)}</div><div class="kpi-cost-sub">${dashMoney(a.scrapCost)} cost of poor quality</div>${kpiDeltaMarkup('copq',a.copqPct,prev.copqPct,false,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true">◈</span></div></div>
 </div>
