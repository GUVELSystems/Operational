...
async function renderStatusFoundation(){
  ...
  const machines=m.data||[], shifts=sh.data||[], customers=c.data||[], parts=p.data||[], personnel=people.data||[], operationList=operations.data||[], operationMachineLinks=opMachines.data||[], partMachineLinks=partMachineLinksResult.data||[], allSessions=sessions.data||[], active=allSessions.filter(x=>['active','running','in_progress'].includes(String(x.status||'').toLowerCase()));
