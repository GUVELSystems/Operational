...
function renderDashboardGeneral(){const box=document.getElementById('dashboardGeneral');if(!box)return;const cmp=dashboardComparison(),a=cmp.current,prev=cmp.previous,p=cmp.period;if(!a.d.prod.length){box.innerHTML='<div class="panel dashboard-empty"><div class="eyebrow">GENERAL</div><h2>No Data</h2><p>No production captures match the selected Dashboard filters.</p></div>';dashboardStatus('No Data in the selected filter scope.');return;}
 ...
 <div class="card kpi-card kpi-oee"><div class="kpi-top"><div class="kpi-label-pill">OEE</div>${kpiGear('oee')}</div><div class="kpi-body"><div><div class="metric kpi-value-oee" ${kpiStatusStyle('oee',a.oee)}>${dashPct(a.oee)}</div>${kpiDeltaMarkup('oee',a.oee,prev.oee,true,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('oee',a.oee)}>◔</span></div></div>
 ...
 <div class="card kpi-card kpi-scrap"><div class="kpi-top"><div class="kpi-label-pill">Scrap</div>${kpiGear('scrap')}</div><div class="kpi-body"><div><div class="metric kpi-value-scrap" ${kpiStatusStyle('scrap',a.scrapPct)}>${dashPct(a.scrapPct)}</div>${kpiDeltaMarkup('scrap',a.scrapPct,prev.scrapPct,false,priorLabel)}</div><span class="kpi-connector" aria-hidden="true"></span><span class="kpi-icon" aria-hidden="true" ${kpiStatusStyle('scrap',a.scrapPct)}>⚠</span></div></div>
